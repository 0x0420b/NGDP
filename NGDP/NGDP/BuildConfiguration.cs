...
namespace NGDP.NGDP
{
    public class BuildConfiguration : AsyncClient
    {
        ...
        public BuildConfiguration(CDNs.Record hostInfo, byte[] buildHash) : base(hostInfo.Hosts[0])
        {
            var queryString = $"/{hostInfo.Path}/config/{buildHash[0]:x2}/{buildHash[1]:x2}/{buildHash.ToHexString()}";
